...
public class ServerChat extends Application {
     ...
     * network connection.
     */
    private TextField messageInput,nameInput,remotePortInput;
    ...
    public void start(Stage stage) {
        ...
        nameInput.setPrefColumnCount(5);
        ...
        HBox connectBar = new HBox(5, listenButton,remotePortInput,new Label("Your name"),nameInput);
        ...
        if (source == listenButton) {
            if (connection == null || 
                ...
                try {
                    ...
                    errorMessage( "is not a legal port number.");
                    return;
                }
                listenButton.setDisable(true);
